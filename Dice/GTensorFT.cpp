...
int main(int argc, char* argv[]) {
  ...
  for (int a = 0; a < 3; a++) {
    ...
    if (!schd.stochastic) {
      fpm[2 * a] = pow(getdEusingDeterministicPT(Dets, ci, E0, I1, I2, I2HBSHM,
    ...
    if (!schd.stochastic) {
      fpm[2 * a + 1] =
          pow(getdEusingDeterministicPT(Dets, ci, E0, I1, I2, I2HBSHM, irrep,
                                        schd, coreE, nelec),
              2);
    } else
  ...
  for (int a = 0; a < 3; a++)
    for (int b = 0; b < a; b++) {
      ...
      if (!schd.stochastic) {
        plusplus = pow(getdEusingDeterministicPT(Dets, ci, E0, I1, I2, I2HBSHM,
                                                 irrep, schd, coreE, nelec),
                       2);
      } else
      ...
      Gtensor(a, b) = (plusplus - fpm[2 * a] - fpm[2 * b] - fpm[2 * a + 1] -
                       fpm[2 * b + 1] + minusminus) /
                      2 / (epsilon * epsilon) / 2;
