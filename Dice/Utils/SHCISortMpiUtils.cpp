...
StitchDEH::StitchDEH() {
  ...
  extra_info = false;
  var_indices =
      std::shared_ptr<vector<vector<int> > >(new vector<vector<int> >());
  orbDifference =
      std::shared_ptr<vector<vector<size_t> > >(new vector<vector<size_t> >());
  var_indices_beforeMerge = std::shared_ptr<vector<int> >(new vector<int>());
  orbDifference_beforeMerge =
      std::shared_ptr<vector<size_t> >(new vector<size_t>());
}
