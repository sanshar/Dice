...
SRC_test = test.cpp Davidson.cpp SHCImakeHamiltonians.cpp
...
SRC_cdfci  = SHCI.cpp SHCIbasics.cpp cdfci.cpp Determinants.cpp integral.cpp input.cpp Davidson.cpp                              SHCIgetdeterminants.cpp SHCIsampledeterminants.cpp SHCIrdm.cpp SHCISortMpiUtils.cpp SHCImakeHamiltonian.cpp SHCIshm.cpp symmetry.cpp OccRestrictions.cpp
...
OBJ_test+=    obj/test.o   obj/SHCIbasics.o   obj/Determinants.o   obj/integral.o   obj/input.o   obj/Davidson.o                                        obj/SHCIgetdeterminants.o   obj/SHCIsampledeterminants.o   obj/SHCIrdm.o   obj/SHCISortMpiUtils.o   obj/SHCImakeHamiltonian.o   obj/SHCIshm.o obj/LCC.o     obj/symmetry.o  obj/OccRestrictions.o
...
OBJ_cdfci+=    obj/SHCI.o   obj/SHCIbasics.o   obj/cdfci.o obj/Determinants.o   obj/integral.o   obj/input.o   obj/Davidson.o                                        obj/SHCIgetdeterminants.o   obj/SHCIsampledeterminants.o   obj/SHCIrdm.o   obj/SHCISortMpiUtils.o   obj/SHCImakeHamiltonian.o   obj/SHCIshm.o obj/symmetry.o  obj/OccRestrictions.o
...
test    : $(OBJ_test)
	$(CXX)   $(FLAGS) $(OPT) -o test $(OBJ_test) $(LFLAGS)
cdfci	: $(OBJ_cdfci)
	$(CXX)   $(FLAGS) $(OPT) -o  cdfci $(OBJ_cdfci) $(LFLAGS)
Dice	: $(OBJ_Dice)
