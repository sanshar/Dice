...
def check_results_fciqmc_replica(eRef1, eRef2, eRefVar, eTest1, eTest2, eTestVar, tol):

    passed_1 = abs(eRef1 - eTest1) < tol
    passed_2 = abs(eRef2 - eTest2) < tol
    passed_var = abs(eRefVar - eTestVar) < tol

    if (passed_1 and passed_2 and passed_var):
        print "test passed"
    else:
        print "test failed"
        print "eRef1 = ", eRef1
...
if __name__ == '__main__':
    ...
    if mc == 'vmc' or mc == 'gfmc' or mc == 'ci':
        ...
        check_results_fciqmc_replica(eRef1, eRef2, eRefVar, eTest1, eTest2, eTestVar, tol)
