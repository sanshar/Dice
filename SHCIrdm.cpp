...
void SHCIrdm::makeRDM(int *&AlphaMajorToBetaLen,
  ...
  */
  ...
  size_t norbs = Determinant::n_spinorbs;
  int nSpatOrbs = Determinant::norbs;
...
void SHCIrdm::EvaluateRDM(vector<vector<int>> &connections, Determinant *Dets,
  ...
  :Arguments:
      ...
      MatrixXx& twoRDM:
          Spin 2RDM.
   */
  size_t norbs = Determinant::n_spinorbs;  // JETS: form old Dice, switch this
                                           // over to new names
  int nSpatOrbs = Determinant::norbs;
...
void SHCIrdm::EvaluateOneRDM(vector<vector<int>> &connections,
  ...
  */
  ...
  size_t norbs =
      Determinant::n_spinorbs;  // JETS: From old Dice, we should clean this up
  int nSpatOrbs = Determinant::norbs;
...
void SHCIrdm::Evaluate3RDM(Determinant *Dets, int DetsSize, CItype *cibra,
  ...
  */
  ...
  size_t norbs = Determinant::n_spinorbs;  // JETS: clean this up
  int nSpatOrbs = Determinant::norbs;
  int nSpatOrbs2 = nSpatOrbs * nSpatOrbs;
