...
void quickSortAll(Determinant* A, int p,int q, double* pNum, double* Energy, vector<int>* var_indices, vector<size_t>* orbDifference, vector<double>* det_energy=NULL, vector<bool>* present=NULL)
{
  int r;
  if(p<q)
    {
