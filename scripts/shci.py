...
try:
    ...
    SHCILIB = cwd+'/../lib/libSHCITools.so'
    libE3unpack = cwd+'/../lib/libicmpspt.so'
except ImportError:
...
import ctypes, numpy
ndpointer = numpy.ctypeslib.ndpointer
libE3unpack = ctypes.cdll.LoadLibrary(libE3unpack)
# TODO: Organize this better.
shciLib = ctypes.cdll.LoadLibrary(SHCILIB)
...
class SHCI(pyscf.lib.StreamObject):
    ...
    def __init__(self, mol=None, maxM=None, tol=None, num_thrds=1,
        ...
        self.executableZDice2 = ZSHCIEXE
