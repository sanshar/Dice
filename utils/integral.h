...
void readDQMCIntegralsR(string fcidump, int& norbs, int& nalpha, int& nbeta, double& ecore, Eigen::MatrixXd& h1, Eigen::MatrixXd& h1Mod, std::vector<Eigen::Map<Eigen::MatrixXd>>& chol);
